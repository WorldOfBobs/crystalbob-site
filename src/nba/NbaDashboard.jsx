...
const API_URL = import.meta.env.VITE_NBA_API_URL || 'https://nba.bobbrowser.com'
...
function NbaDashboard() {
  ...
  return (
    <div className="nba-native app">
      <header className="header banner-header banner-header--embedded">
        <div className="banner-top banner-top--embedded">
          <div className="banner-copy banner-copy--embedded">
            <div className="banner-meta-row">
              <span className="banner-sport-chip">NBA Dashboard</span>
              <span className="banner-meta-inline">Updated {today}</span>
            </div>
          </div>
        </div>
